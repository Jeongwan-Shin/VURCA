...
if __name__ == "__main__":
    ...
    parser.add_argument("--pre_task", type=str, default="gen_total_question_ver3", help="")
    parser.add_argument("--task", type=str, default="answer_qa_total", help="")
        ...
        for res in pre_resFile:
            for idx in range(5):
                ...
                for q in op['gen_question']:
                    ...
                    answer_list.append(outputs[0].outputs[0].text)
                op['gen_answer'] = answer_list
